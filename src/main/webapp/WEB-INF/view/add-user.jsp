...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <div class="container">
    	<div class="row">
    		<div class="col-md-8 offset-md-2 mt-5 mb-5">
    			<div class="card">
    				<h3 class="card-title text-center p-3">Add New User</h3>
    				<div class="card-body">
	...
	<script type="text/javascript" src="${ pageContext.request.contextPath }/resources/js/soft-ui-dashboard.min.js"></script>
